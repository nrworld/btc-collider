...
PORT=$((${port}+10001))
JAVA_OPTS="--illegal-access=permit --add-exports java.base/jdk.internal.ref=ALL-UNNAMED
 ...
 -Dcom.sun.management.jmxremote.ssl=false -Djava.rmi.server.hostname=$IP -Xmx1g -Djava.awt.headless=true
